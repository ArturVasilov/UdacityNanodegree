...
public class ActivityMoviesBinding extends android.databinding.ViewDataBinding  {
    ...
    public final arturvasilov.udacity.nanodegree.popularmoviesdatabinding.widget.EmptyRecyclerView recyclerView;
    // variables
    ...
    public ActivityMoviesBinding(android.databinding.DataBindingComponent bindingComponent, View root) {
        ...
        this.recyclerView = (arturvasilov.udacity.nanodegree.popularmoviesdatabinding.widget.EmptyRecyclerView) bindings[1];
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x29L) != 0) {
            ...
            arturvasilov.udacity.nanodegree.popularmoviesdatabinding.databinding.adapters.RecyclerAdapters.setMovies(this.recyclerView, moviesModel);
        }
        if ((dirtyFlags & 0x27L) != 0) {
            // api target 1

            arturvasilov.udacity.nanodegree.popularmoviesdatabinding.databinding.adapters.RecyclerAdapters.initRecycler(this.recyclerView, layoutManagerModel, adapterModel, empty, (arturvasilov.udacity.nanodegree.popularmoviesdatabinding.widget.BaseAdapter.OnItemClickListener)arturvasilovUdacityN);
        }
    }
    ...
    public static ActivityMoviesBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    public static ActivityMoviesBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityMoviesBinding>inflate(inflater, arturvasilov.udacity.nanodegree.popularmoviesdatabinding.R.layout.activity_movies, root, attachToRoot, bindingComponent);
    }
    public static ActivityMoviesBinding inflate(android.view.LayoutInflater inflater) {
        return inflate(inflater, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    public static ActivityMoviesBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(arturvasilov.udacity.nanodegree.popularmoviesdatabinding.R.layout.activity_movies, null, false), bindingComponent);
    }
    public static ActivityMoviesBinding bind(android.view.View view) {
        return bind(view, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    public static ActivityMoviesBinding bind(android.view.View view, android.databinding.DataBindingComponent bindingComponent) {
        if (!"layout/activity_movies_0".equals(view.getTag())) {
            throw new RuntimeException("view tag isn't correct on view:" + view.getTag());
        }
        return new ActivityMoviesBinding(bindingComponent, view);
    }
    /* flag mapping
        flag 0 (0x1L): model
